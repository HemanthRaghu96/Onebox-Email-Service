...
const InboxHeader: React.FC<headerProps> = ({ currColor }) => {
  ...
  return (
    <>
      ...
      <div  className="w-[160px] h-[47px]  p-[10px] pt-0 pr-0 pb-0 pl-0 gap-[4px] opacity-[0px] flex justify-center items-center">
      ...
      <p className='text-left  text-[14px] absolute top-[55px] left-[14px]'>25/25 <span className=' text-[#7F7F7F]'>Inboxes selected</span></p>
      </div>
      <div
        className={`w-[32px] h-[32px] p-[8px] pt-0 pr-0 pb-0 pl-0 gap-[8px]  opacity-[0px] absolute top-[17px] left-[240px]
            ${
